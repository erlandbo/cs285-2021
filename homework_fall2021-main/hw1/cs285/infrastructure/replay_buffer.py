...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        return (
            self.obs[random_indices][-batch_size:],
            self.acs[random_indices][-batch_size:],
            self.rews[random_indices][-batch_size:],
            self.next_obs[random_indices][-batch_size:],
            self.terminals[random_indices][-batch_size:]
        )
