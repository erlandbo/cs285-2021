...
class BootstrappedContinuousCritic(nn.Module, BaseCritic):
    ...
    def update(self, ob_no, ac_na, next_ob_no, reward_n, terminal_n):
        ...
        ob_no, ac_na, next_ob_no = ptu.from_numpy(ob_no), ptu.from_numpy(ac_na), ptu.from_numpy(next_ob_no)
        reward_n, terminal_n = ptu.from_numpy(reward_n), ptu.from_numpy(terminal_n)
        loss = 0.
